        ...
        <div class="card-body">
          ...
          <form id="form" class="mt-4" method="post" action="/profile/edit" enctype="multipart/form-data">
            ...
            <div class="form-group mt-4">
              ...
              <input type="text" name="name" class="form-control" id="exampleInputEmail1" value="{{\Auth::user()->name}}" aria-describedby="emailHelp" placeholder="Enter name" required>
            </div>

            <div class="form-group">
              <label class="form-label">Location</label>
              <input id="pac-input" name="location" class="controls" type="text" value="{{\Auth::user()->location}}" placeholder="Enter a location" >
              <div id="map"></div>
